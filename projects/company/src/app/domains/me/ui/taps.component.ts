...
<div class="mfe-company-space-y-2">
  <div class="mfe-company-mt-4">
    <ng-container *ngFor="let content of contents">
      <ng-container *ngIf="currentTab() === content.label() && content.template()">
...
export class TabsComponent implements AfterContentInit {
  ...
  getTabClass(tab: string): string {
    const base = 'mfe-company-py-2 mfe-company-px-1 mfe-company-font-medium mfe-company-text-sm mfe-company-whitespace-nowrap mfe-company-focus:outline-none';
